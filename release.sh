...
git push "https://$username:$password@github.com/carlosthe19916/jasper-utils.git"

# Create tag and push
git tag "$releaseVersion"
git push "https://$username:$password@github.com/carlosthe19916/jasper-utils.git" --tags
